...
type Handler interface {
	...
	// Handler implementations should not modify the slice.
	//
	// TODO: impose constraints, like "Handler implementations must not retain a
	// reference to the slice's array"?
