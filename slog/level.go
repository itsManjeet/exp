...
//
// Second, we wanted to make it easy to work with verbosities instead of (or in
// addition to) levels.
// Verbosities start at 0, corresponding to the Info level,
// and more positive values are more verbose (less severe).
// To convert a verbosity into a Level, negate it.
// For example, to log at verbosity 2, call [Logger.Log] with -2.
//
