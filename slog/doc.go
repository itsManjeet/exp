...
Some handlers may wish to include information from the [current.Context] that is
available at the call site. One example of such data is the identifier for a
telemetry trace.
