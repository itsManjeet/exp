...
//
// TestHandler uses the given Handler to create several log events
// (for example, a single call to [slog.Logger.Info]).
//
// The results function should return a slice of map[string]any, one for each log event.
