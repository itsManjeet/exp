...
func TestConnections(t *testing.T) {
	...
	t.Run("wrap default handler", func(t *testing.T) {
		...
		// the log package.
		//
		// When slog lives under log in the standard library, we can move the bulk of
		// log.Logger.Output to a function in an internal package, so both log and slog
		// can call it. While slog lives in exp, we punt.
