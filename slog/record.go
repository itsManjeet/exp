...
type Record struct {
	...
	n1 int
	// The remaining Attrs. Non-nil iff n1 == nAttrsInline.
	attrs2 []Attr
}
...
func (r *Record) Attrs() []Attr {
	...
	return concat(r.attrs1[:r.n1], r.attrs2)
}

// NumAttrs returns the number of Attrs in r.
func (r *Record) NumAttrs() int {
	return r.n1 + len(r.attrs2)
}
