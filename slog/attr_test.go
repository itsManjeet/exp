...
func (kv Attr) AsString() (string, bool) {
...
func (kv Attr) AsInt64() (int64, bool) {
	if kv.Kind() == Int64Kind {
		return int64(kv.u), true
	}
	return 0, false
}

func (kv Attr) AsUint64() (uint64, bool) {
	if kv.Kind() == Uint64Kind {
		return kv.u, true
	}
	return 0, false
}

func (kv Attr) AsFloat64() (float64, bool) {
	if kv.Kind() == Float64Kind {
		return kv.float(), true
	}
	return 0, false
}

func (kv Attr) AsBool() (bool, bool) {
	if kv.Kind() == BoolKind {
		return kv.bool(), true
	}
	return false, false
...
func (kv Attr) AsDuration() (time.Duration, bool) {
	if kv.Kind() == DurationKind {
		return kv.duration(), true
	}
	return 0, false
}

func (kv Attr) AsAny() (any, bool) {
	if kv.Kind() == AnyKind {
		return kv.a, true
	}
	return nil, false
