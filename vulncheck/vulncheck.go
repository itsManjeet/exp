...
// to the program entry functions (see FuncNode).
...
// directed, i.e., from a vulnerable module to the program entry modules (see ModNode).
...
// i.e., from a vulnerable package to the program entry packages (see PkgNode).
