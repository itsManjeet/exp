		...
		ret: map[string][]*osv.Entry{
			"thirdparty.org/vulnerabilities": []*osv.Entry{
				...
				},
				{
					...
					Affected: []osv.Affected{{
						Package:           osv.Package{Name: "thirdparty.org/vulnerabilities/vuln"},
						Ranges:            osv.Affects{{Type: osv.TypeSemver, Events: []osv.RangeEvent{{Introduced: "1.0.0", Fixed: "1.0.7"}}}},
						EcosystemSpecific: osv.EcosystemSpecific{Symbols: []string{"VulnParse"}},
					}},
				},
				{
					ID: "V4",
					Affected: []osv.Affected{{
						Package:           osv.Package{Name: "thirdparty.org/vulnerabilities/othervuln"},
						Ranges:            osv.Affects{{Type: osv.TypeSemver, Events: []osv.RangeEvent{{Introduced: "1.0.0"}}}},
						EcosystemSpecific: osv.EcosystemSpecific{Symbols: []string{"VG"}},
					}},
				},
			},
