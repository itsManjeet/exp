		...
		ret: map[string][]*osv.Entry{
			"thirdparty.org/vulnerabilities": []*osv.Entry{
				...
				},
				{
					ID:                "V3",
					Package:           osv.Package{Name: "thirdparty.org/vulnerabilities/vuln"},
					Affects:           osv.Affects{Ranges: []osv.AffectsRange{{Type: osv.TypeSemver, Introduced: "1.0.0", Fixed: "1.0.7"}}},
					EcosystemSpecific: osv.GoSpecific{Symbols: []string{"VulnParse"}},
				},
				{
					ID:                "V4",
					Package:           osv.Package{Name: "thirdparty.org/vulnerabilities/othervuln"},
					Affects:           osv.Affects{Ranges: []osv.AffectsRange{{Type: osv.TypeSemver, Introduced: "1.0.0"}}},
					EcosystemSpecific: osv.GoSpecific{Symbols: []string{"VG"}},
				},
			},
		},
