...
type Conn interface {
	...
	// SetActiveLow configures the definition of active value for the GPIO
	// pin. Given 0, low values (0) will be active. Given 1, high values
	// will be active.
	SetActive(pin int, v int) error
