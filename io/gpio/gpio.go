...
// SetActive configures whether low (0) or high (1) values are considered
// active for the pin.
...
// Given 1, the active value will be high. Given 0, the active value
// will be low.
func (d *Device) SetActive(pin int, v int) error {
	return d.conn.SetActive(pin, v)
}
