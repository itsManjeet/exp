...
// String returns the error string of the given error formatter.
func String(err Formatter) string {
	return fmt.Sprint(stringAdaptor{err})
}
...
func (e stringAdaptor) Format(s fmt.State, verb rune) {
