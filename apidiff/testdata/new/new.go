...
const (
	...
	C2 = -1  //c C2: changed from int to untyped int
	//i C2: can no longer represent uint8
	C3 int = 4 //i C3: changed from untyped int to int
	V8 int = 1 //i V8: changed from var to const
	C4 u2  = 1
	C5     = false  //c C5: changed from bool to untyped bool
	C6     = 10     //c C6: changed from uint to untyped int
	C7     = "7"    //c C7: changed from string to untyped string
	C8     = 3.1    //c C8: changed from float64 to untyped float
	C9     = 1 + 2i //c C9: changed from complex64 to untyped complex
