...
func Sort[E constraints.Ordered](x []E) {
	...
	case reflect.Float64:
		SortFunc(*(*[]float64)(unsafe.Pointer(&x)), func(a, b float64) bool { return a < b || (math.IsNaN(a) && !math.IsNaN(b)) })
	case reflect.Float32:
		SortFunc(*(*[]float32)(unsafe.Pointer(&x)), func(a, b float32) bool { return a < b || (isNaN32(a) && !isNaN32(b)) })
	default:
