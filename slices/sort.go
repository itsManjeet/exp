...
//
// WARNING: The algorithm requires strict weak ordering(https://en.wikipedia.org/wiki/Weak_ordering#Strict_weak_orderings).
// A float64 slice contains NaNs can violate this rule, the result is not guaranteed
// to be sorted eventually. Use sort.Float64s in this case.
...
//
// WARNING: The algorithm requires strict weak ordering(https://en.wikipedia.org/wiki/Weak_ordering#Strict_weak_orderings).
// If violate this rule, the result is not guaranteed to be sorted eventually.
