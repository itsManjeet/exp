...
// TODO: move these functions into the standard library's package image?
...
// and r.Inset(inset). The inset may be negative, in which case the points will
// be outside r. Visually:
//
//	00000000
//	00000000
//	11....22
