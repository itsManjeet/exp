...
#define IS_MAC_SERRIA_OR_LATER (NSAppKitVersionNumber - NSAppKitVersionNumber10_11)

// The variables did not exist before macOS version, we use that old variables
// that had deprecated on macOS to define them.
#if !IS_MAC_SERRIA_OR_LATER
enum
{
