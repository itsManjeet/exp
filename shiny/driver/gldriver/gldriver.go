...
// writeAff3 must only be called while holding windowImpl.mu.
...
// compileProgram must only be called while holding windowImpl.mu.
...
// compileShader must only be called while holding windowImpl.mu.
