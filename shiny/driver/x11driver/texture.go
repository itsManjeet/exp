...
func (t *textureImpl) draw(xp render.Picture, src2dst *f64.Aff3, sr image.Rectangle, op draw.Op, w, h int, opts *screen.DrawOptions) {
	...
	dst2src := [6]float64{
		src2dst[4] / (src2dst[0]*src2dst[4] - src2dst[1]*src2dst[3]),
		src2dst[1] / (src2dst[1]*src2dst[3] - src2dst[0]*src2dst[4]),
		(src2dst[2]*src2dst[4] - src2dst[1]*src2dst[5]) / (src2dst[1]*src2dst[3] - src2dst[0]*src2dst[4]),
		src2dst[3] / (src2dst[1]*src2dst[3] - src2dst[0]*src2dst[4]),
		src2dst[0] / (src2dst[0]*src2dst[4] - src2dst[1]*src2dst[3]),
		(src2dst[2]*src2dst[3] - src2dst[0]*src2dst[5]) / (src2dst[0]*src2dst[4] - src2dst[1]*src2dst[3]),
	}
