...
// The dialog manager (IsDialogMessage) sends several messages
// in the WM_USER area to whatever window you ask it to manage.
// Let's avoid colliding, just to be safe.
