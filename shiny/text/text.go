...
type Frame struct {
	...
	// (Paragraphs) forms a linked list, not an array list, so that insertion
	// has lower algorithmic complexity. Similarly for a Paragraph's list of
	// children (Lines) and a Line's list of children (Boxes).
	//
