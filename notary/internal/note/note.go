...
// to sign the concatenation of the note text, a blank line (only a newline),
// and the key's associated name.
//
// Generating Keys
//
...
// Encodings
//
// The key hash for a given notary key is
// In terms of the golang.org/x/crypto/ed25519 package,
// the encoded public key is a 32-byte value suitable for direct
// conversion to ed25519.PublicKey; the encoded private key is a
// 32-byte value to pass to ed25519.NewKeyFromSeed.
//
//
...
// Open records the signature in the returned note,
// but with UnverifiedName and UnverifiedHash set instead of Name and Hash.
