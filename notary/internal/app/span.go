...
import (
	...
	"golang.org/x/exp/notary/internal/database/spandb"
...
func (noteServer) ReadContent(ctx context.Context, id int64) ([]byte, error) {
	return getDB(ctx).ReadContent(ctx, id)
}
