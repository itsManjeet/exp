...
//
// For all types other than *types.TypeParam, *types.Interface (possibly
// *Named), and *types.Union, this is just a single term with Tilde() == false
// and Type() == typ. For *types.TypeParam, *types.Interface, and *types.Union,
// see below.
//
