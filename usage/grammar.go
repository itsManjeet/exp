...
func parseTitle(in *input) sname {
	name := parseName(in)
	scanRune(in, ':')
...
func (p *parsePage) defaultValue(in *input) {
	...
	//TODO: do we want better quoted default value handling?
...
func parseName(in *input) sname {
	return makeSName(scanCapture(in, func(in *input) {
