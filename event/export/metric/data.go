...
func labelListEqual(a, b []event.Label) bool {
	//TODO: make this more efficient
	return fmt.Sprint(a) == fmt.Sprint(b)
}

func labelListLess(a, b []event.Label) bool {
	//TODO: make this more efficient
	return fmt.Sprint(a) < fmt.Sprint(b)
}

func getGroup(ev event.Event, g *[][]event.Label, keys []event.Key) (int, bool) {
	group := make([]event.Label, len(keys))
...
func (data *Int64Data) Groups() [][]event.Label { return data.groups }

func (data *Int64Data) modify(at time.Time, lm event.Event, f func(v int64) int64) Data {
...
func (data *Int64Data) count(at time.Time, lm event.Event, l event.Label) Data {
	return data.modify(at, lm, func(v int64) int64 {
		return v + 1
	})
}

func (data *Int64Data) sum(at time.Time, lm event.Event, l event.Label) Data {
	return data.modify(at, lm, func(v int64) int64 {
		return v + data.key.From(l)
	})
}

func (data *Int64Data) latest(at time.Time, lm event.Event, l event.Label) Data {
	return data.modify(at, lm, func(v int64) int64 {
...
func (data *Float64Data) Groups() [][]event.Label { return data.groups }

func (data *Float64Data) modify(at time.Time, lm event.Event, f func(v float64) float64) Data {
	index, insert := getGroup(lm, &data.groups, data.Info.Keys)
	old := data.Rows
	if insert {
...
func (data *Float64Data) sum(at time.Time, lm event.Event, l event.Label) Data {
	return data.modify(at, lm, func(v float64) float64 {
		return v + data.key.From(l)
	})
}

func (data *Float64Data) latest(at time.Time, lm event.Event, l event.Label) Data {
	return data.modify(at, lm, func(v float64) float64 {
		return data.key.From(l)
	})
}
...
func (data *HistogramInt64Data) Groups() [][]event.Label { return data.groups }

func (data *HistogramInt64Data) modify(at time.Time, lm event.Event, f func(v *HistogramInt64Row)) Data {
	index, insert := getGroup(lm, &data.groups, data.Info.Keys)
	old := data.Rows
...
func (data *HistogramInt64Data) record(at time.Time, lm event.Event, l event.Label) Data {
...
func (data *HistogramFloat64Data) Groups() [][]event.Label { return data.groups }

func (data *HistogramFloat64Data) modify(at time.Time, lm event.Event, f func(v *HistogramFloat64Row)) Data {
	index, insert := getGroup(lm, &data.groups, data.Info.Keys)
	old := data.Rows
...
func (data *HistogramFloat64Data) record(at time.Time, lm event.Event, l event.Label) Data {
