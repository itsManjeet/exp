...
`}, {
		...
		expect: `time=2020-03-05T14:27:48 id=1 kind=metric l1=1 namespace=test name=m1 value=3`,
	}, {
		name:   "metric 2",
		events: func(ctx context.Context) { event.To(ctx).With(l1).With(l2).FloatMetric("test", "m2", 1.4) },
		expect: `time=2020-03-05T14:27:48 id=1 kind=metric l1=1 l2=2 namespace=test name=m2 value=1.4`,
	}, {
		name:   "annotate",
