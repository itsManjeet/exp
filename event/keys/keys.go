...
func (k Value) Of(v interface{}) event.Label {
	l := event.Label{Key: string(k)}
	l.Value.SetInterface(v)
	return l
}
...
func (k Tag) New() event.Label {
	return event.Label{Key: string(k)}
}
