...
func (e Event) Task() Task {
	...
	if e.base.typ != go122.EvUserTaskBegin && e.base.typ != go122.EvUserTaskEnd {
...
func (e Event) StateTransition() StateTransition {
	...
	case go122.EvProcSteal:
		// N.B. ordering.advance populates e.base.args[3].
		beforeState := ProcRunning
		if go122.ProcStatus(e.base.args[3]) == go122.ProcSyscallAbandoned {
	...
	case go122.EvProcStatus:
		// N.B. ordering.advance populates e.base.args[2].
		s = procStateTransition(ProcID(e.base.args[0]), ProcState(e.base.args[2]), go122ProcStatus2ProcState[e.base.args[1]])
	...
	case go122.EvGoStatus:
		// N.B. ordering.advance populates e.base.args[2].
		s = goStateTransition(GoID(e.base.args[0]), GoState(e.base.args[2]), go122GoStatus2GoState[e.base.args[1]])
	default:
...
func go122DumpEvent(e Event) string {
