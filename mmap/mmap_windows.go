...
func (r *ReaderAt) Close() error {
	...
	return syscall.UnmapViewOfFile(r.ptr)
}
...
func Open(filename string) (*ReaderAt, error) {
	...
	fmap, err := syscall.CreateFileMapping(syscall.Handle(f.Fd()), nil, syscall.PAGE_READONLY, 0, uint32(size), nil)
	if err != nil {
		return nil, err
	}
